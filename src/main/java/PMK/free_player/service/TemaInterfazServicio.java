...
import PMK.free_player.repository.TemaInterfazRepositorio;
import PMK.free_player.service.interfaces.ITemaInterfaz;
...
public class TemaInterfazServicio implements ITemaInterfaz{
    ...
    public Optional<TemaInterfaz> FindTemaInterfazById(Integer idTema) {
        ...
        if (temaInterfaz.isEmpty()) {
            ...
            throw new RecursoNoEncontradoException("Tema de interfaz no encontrado con ID: " + idTema);
        }
        return temaInterfaz;
    }
